...
try:
    ...
    #disp = LCD_2inch8.LCD_2inch8(spi=SPI.SpiDev(bus, device),spi_freq=10000000,rst=RST,dc=DC,bl=BL)
    ...
    draw.rectangle([(0,115),(210,160)],fill = "RED")
    draw.text((5, 118), 'ELECROW', fill = "WHITE",font=Font2)
    ...
    image = Image.open('../pic/LCD_2inch8.png')
